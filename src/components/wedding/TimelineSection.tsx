...
const timelineEvents: TimelineEvent[] = [
  {
    date: "Spring 2019",
    title: "First Meeting",
    description: "A rainy afternoon in London when our paths crossed at a cozy bookshop in Notting Hill.",
    image: img0528,
    position: "left",
  },
  {
    date: "Summer 2019",
    title: "First Date",
    description: "Coffee turned into dinner, dinner turned into a walk by the Thames, and we talked until sunrise.",
    image: img1868,
    position: "right",
  },
  {
    ...
    description: "A magical weekend in the Scottish Highlands, where we discovered our shared love for adventure.",
    image: img7239,
    position: "left",
  },
  {
    ...
    description: "We found a little flat with a view of the sunset, and it became our sanctuary.",
    image: img7528,
    position: "right",
  },
  {
    date: "Autumn 2021",
    title: "The Proposal",
    description: "Under a canopy of fairy lights at sunset, with the city skyline as our witness, he asked and she said yes.",
    image: img7617,
    position: "left",
  },
  {
    ...
    description: "Surrounded by love, laughter, and all the people who matter most. Our forever begins here.",
    image: couplePhoto,
    position: "right",
  },
];
